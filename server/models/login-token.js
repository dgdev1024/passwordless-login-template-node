/**
 * @file server/models/login-token.js
 * The database model for our login tokens.
 */
...
const b64 = require('../utility/base64');
...
/**
 * @function check
 * Checks a submitted login verify code and nonce candidate against the
